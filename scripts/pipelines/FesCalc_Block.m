function FesCalc_Block(pname, struct_file, ene, DS, DCp, T, IS)
    ...
    %% Input Parameters
    pdb = char(pname); % Input PDB file name, Make sure to run cmapCalcElec_Block.m and generate necessary input files
